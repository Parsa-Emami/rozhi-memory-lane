    ...
    <div class="mt-12 grid items-center gap-8 lg:grid-cols-[.85fr_1.15fr]">
        <div class="glass-card p-7 text-center">
            <div id="vibe-spinner-display" class="spin-display">
                <img src="<?php echo e(asset(config('rozhi.cat_image'))); ?>" onerror="this.onerror=null;this.src='<?php echo e(asset('images/black-kitten.svg')); ?>'" alt="black kitten" class="mx-auto w-44">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <?php $__currentLoopData = $spinCards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <article class="spin-card glass-card p-6" data-emoji="<?php echo e($card['emoji']); ?>" data-title="<?php echo e($card['title']); ?>" data-text="<?php echo e($card['text']); ?>">
                    <div class="flex items-center justify-between gap-4">
                        <span class="text-5xl"><?php echo e($card['emoji']); ?></span>
                        <span class="rounded-full bg-white/60 px-3 py-1 text-xs font-black dark:bg-white/10"><?php echo e($card['tag']); ?></span>
                    </div>
                    <h2 class="mt-5 text-2xl font-black"><?php echo e($card['title']); ?></h2>
                    <p class="mt-3 leading-8 text-cocoa/70 dark:text-white/70"><?php echo e($card['text']); ?></p>
                </article>
...
<?php echo $__env->make('layouts.app', ['title' => 'Spin - Rozhi Coffee Plan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alienware\Desktop\rozhi-memory-lane\resources\views\pages\story.blade.php ENDPATH**/ ?>