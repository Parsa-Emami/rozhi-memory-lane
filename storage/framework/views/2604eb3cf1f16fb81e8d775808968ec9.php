        ...
        <?php $__currentLoopData = $cards; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $card): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <article class="glass-card flex h-full flex-col p-7 transition hover:-translate-y-2">
                <div class="flex items-start justify-between gap-4">
                    <div class="text-6xl"><?php echo e($card['emoji']); ?></div>
                ...
                <p class="mt-auto pt-5 text-sm font-black text-blush-400"><?php echo e($card['note']); ?></p>
            </article>
...
<?php echo $__env->make('layouts.app', ['title' => 'Ideas - Rozhi Coffee Plan'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\alienware\Desktop\rozhi-memory-lane\resources\views/pages/future.blade.php ENDPATH**/ ?>