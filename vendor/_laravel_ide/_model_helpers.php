...
namespace App\Models {
     ...
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereNickname($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereMood($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereAnswer($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereIpHash($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<LetterReply>|LetterReply query()
     ...
     */
    class LetterReply extends \Illuminate\Database\Eloquent\Model
    {
        //
    }
     ...
     * @property \Illuminate\Support\Carbon|null $memory_date
     * @property string|null $place
     * @property string $title
     * @property int $id
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereTitle($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory wherePlace($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereMemoryDate($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereDescription($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereImagePath($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereMood($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereSortOrder($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereIsFeatured($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereCreatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory whereUpdatedAt($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory newModelQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory newQuery()
     * @method static \Illuminate\Database\Eloquent\Builder<Memory>|Memory query()
     * @method static mixed select($columns)
     * @method static mixed selectSub($query, $as)
     * @method static mixed selectRaw($expression, array $bindings)
     * @method static mixed fromSub($query, $as)
     ...
     * @property \Illuminate\Support\Carbon|null $created_at
     * @property int $sort_order
     * @property string|null $emotional_result
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<QuizQuestion>|QuizQuestion whereEmotionalResult($value)
     ...
     * @method static \Illuminate\Database\Eloquent\Builder<Visit>|Visit whereSessionId($value)
     * @method static \Illuminate\Database\Eloquent\Builder<Visit>|Visit whereIpHash($value)
